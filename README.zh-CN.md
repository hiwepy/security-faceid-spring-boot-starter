...
**security-faceid-spring-boot-starter** 是一个面向 使用 security-biz 的应用 的 Spring Boot Starter，用于将 **security-biz** 集成到 Spring Boot 应用中。它提供自动装配、属性绑定与开箱即用的 Bean，使应用以最小配置即可使用 security-biz 的全部能力。
...
| JDK | `17` |
| 坐标 | `io.github.easy4j:security-faceid-spring-boot-starter:3.4.x.20260527-SNAPSHOT` |
